...
class TestBuddy(TestCase):
    ...
    def test_buddy_alloc(self):
        ...
        for test in test_cases:
            ...
            self.assertEqual(
                test["name"] in buddy.name_list, test["expected_list_names"]
            )
    ...
    def test_free(self):
        ...
        alloc_test_cases = [
            ...
            },
            {
                "name": "Block 3",
                "size": 16,
                "expected_list": [[], [], [], [], [(48, 63)], [], [(64, 127)], []],
                "expected_list_names": True,
            },
            {
                "name": "Block 4",
                "size": 16,
                "expected_list": [[], [], [], [], [], [], [(64, 127)], []],
                "expected_list_names": True,
            },
        ]
        ...
        free_test_cases = [
            {
                "name": "Block 1",
                "expected_list": [[], [], [], [], [(0, 15)], [], [(64, 127)], []],
                "expected_list_names": False,
            },
            {
                "name": "Block No Allocate",
                "expected_list": [[], [], [], [], [(0, 15)], [], [(64, 127)], []],
                "expected_list_names": False,
            },
            {
    ...
    def test_run_simulation(self):
        ...
        invalid_input_test_cases = [
            "reservar sin parametros",
            "reservar bloque_0",
            "liberar sin parametros",
            "liberar 1220",
            "mostrar",
            "salir",
        ]
        ...
        with mock.patch("builtins.input", side_effect=invalid_input_test_cases):
            ...
            self.assertEqual(
                buddy5.block_list, [[], [], [], [], [], [(32, 63)], [(64, 127)], []]
            )
